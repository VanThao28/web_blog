                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="trending-top mb-30">
                            <div class="trend-top-img">
                                <img src="/themes/aznews/assets/img/trending/trending_top.jpg" alt="">
                                <div class="trend-top-cap">
                                    <span>Appetizers</span>
                                    <h2><a href="{{route('clinet.detail')}}">Welcome To The Best Model Winner<br> Contest At Look of the year</a></h2>
                                </div>
                            </div>
                        </div>
                        <!-- Trending Bottom -->
                                ...
                                <div class="col-lg-4">
                                    <div class="single-bottom mb-35">
                                        <div class="trend-bottom-img mb-30">
                                            <img src="/themes/aznews/assets/img/trending/trending_bottom1.jpg" alt="">
                                        </div>
                                        <div class="trend-bottom-cap">
                                            <span class="color1">Lifestyple</span>
                                            <h4><a href="{{route('clinet.detail')}}">Get the Illusion of Fuller Lashes by “Mascng.”</a></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="single-bottom mb-35">
                                        <div class="trend-bottom-img mb-30">
                                            <img src="/themes/aznews/assets/img/trending/trending_bottom2.jpg" alt="">
                                        </div>
                                        <div class="trend-bottom-cap">
                                            <span class="color2">Sports</span>
                                            <h4><h4><a href="{{route('clinet.detail')}}">Get the Illusion of Fuller Lashes by “Mascng.”</a></h4></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="single-bottom mb-35">
                                        <div class="trend-bottom-img mb-30">
                                            <img src="/themes/aznews/assets/img/trending/trending_bottom3.jpg" alt="">
                                        </div>
                                        <div class="trend-bottom-cap">
                                            <span class="color3">Travels</span>
                                            <h4><a href="{{route('clinet.detail')}}"> Welcome To The Best Model Winner Contest</a></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="trand-right-single d-flex">
                            <div class="trand-right-img">
                                <img src="/themes/aznews/assets/img/trending/right1.jpg" alt="">
                            </div>
                        ...
                        <div class="trand-right-single d-flex">
                            <div class="trand-right-img">
                                <img src="/themes/aznews/assets/img/trending/right2.jpg" alt="">
                            </div>
                            <div class="trand-right-cap">
                        ...
                        <div class="trand-right-single d-flex">
                            <div class="trand-right-img">
                                <img src="/themes/aznews/assets/img/trending/right3.jpg" alt="">
                            </div>
                            <div class="trand-right-cap">
                        ...
                        <div class="trand-right-single d-flex">
                            <div class="trand-right-img">
                                <img src="/themes/aznews/assets/img/trending/right4.jpg" alt="">
                            </div>
                            <div class="trand-right-cap">
                        ...
                        <div class="trand-right-single d-flex">
                            <div class="trand-right-img">
                                <img src="/themes/aznews/assets/img/trending/right5.jpg" alt="">
                            </div>
                            <div class="trand-right-cap">
                        ...
                        <div class="weekly-news-active dot-style d-flex dot-style">
                            <div class="weekly-single">
                                <div class="weekly-img">
                                    <img src="/themes/aznews/assets/img/news/weeklyNews2.jpg" alt="">
                                </div>
                            ...
                            <div class="weekly-single active">
                                <div class="weekly-img">
                                    <img src="/themes/aznews/assets/img/news/weeklyNews1.jpg" alt="">
                                </div>
                                <div class="weekly-caption">
                                    <span class="color1">Strike</span>
                                    <h4><a href="#">Welcome To The Best Model  Winner Contest</a></h4>
                            ...
                            <div class="weekly-single">
                                <div class="weekly-img">
                                    <img src="/themes/aznews/assets/img/news/weeklyNews3.jpg" alt="">
                                </div>
                                <div class="weekly-caption">
                                    <span class="color1">Strike</span>
                                    <h4><a href="#">Welcome To The Best Model  Winner Contest</a></h4>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6">
                                                <div class="single-what-news mb-100">
                                                    <div class="what-img">
                                                        <img src="/themes/aznews/assets/img/news/whatNews1.jpg" alt="">
                                                    </div>
                                                    <div class="what-cap">
                                            ...
                                            <div class="col-lg-6 col-md-6">
                                                <div class="single-what-news mb-100">
                                                    <div class="what-img">
                                                        <img src="/themes/aznews/assets/img/news/whatNews2.jpg" alt="">
                                                    </div>
                                                    <div class="what-cap">
                                                        <span class="color1">Night party</span>
                                                        <h4><a href="#">Welcome To The Best Model  Winner Contest</a></h4>
                                            ...
                                            <div class="col-lg-6 col-md-6">
                                                <div class="single-what-news mb-100">
                                                    <div class="what-img">
                                                        <img src="/themes/aznews/assets/img/news/whatNews3.jpg" alt="">
                                                    </div>
                                                    <div class="what-cap">
                                                        <span class="color1">Night party</span>
                                                        <h4><a href="#">Welcome To The Best Model  Winner Contest</a></h4>
                                            ...
                                            <div class="col-lg-6 col-md-6">
                                                <div class="single-what-news mb-100">
                                                    <div class="what-img">
                                                        <img src="/themes/aznews/assets/img/news/whatNews4.jpg" alt="">
                                                    </div>
                                                    <div class="what-cap">
                                                        <span class="color1">Night party</span>
                                                        <h4><a href="#">Welcome To The Best Model  Winner Contest</a></h4>
                        ...
                        <div class="weekly2-news-active dot-style d-flex dot-style">
                            <div class="weekly2-single">
                                <div class="weekly2-img">
                                    <img src="/themes/aznews/assets/img/news/weekly2News1.jpg" alt="">
                                </div>
                            ...
                            <div class="weekly2-single">
                                <div class="weekly2-img">
                                    <img src="/themes/aznews/assets/img/news/weekly2News2.jpg" alt="">
                                </div>
                                <div class="weekly2-caption">
                            ...
                            <div class="weekly2-single">
                                <div class="weekly2-img">
                                    <img src="/themes/aznews/assets/img/news/weekly2News3.jpg" alt="">
                                </div>
                                <div class="weekly2-caption">
                                    <span class="color1">Corporate</span>
                                    <p>25 Jan 2020</p>
                            ...
                            <div class="weekly2-single">
                                <div class="weekly2-img">
                                    <img src="/themes/aznews/assets/img/news/weekly2News4.jpg" alt="">
                                </div>
                                <div class="weekly2-caption">
                    ...
                    <div class="col-12">
                        <div class="recent-active dot-style d-flex dot-style">
                            <div class="single-recent mb-100">
                                <div class="what-img">
                                    <img src="/themes/aznews/assets/img/news/recent1.jpg" alt="">
                                </div>
                                <div class="what-cap">
                                    <span class="color1">Night party</span>
                                    <h4><a href="#">Welcome To The Best Model  Winner Contest</a></h4>
                            ...
                            <div class="single-recent mb-100">
                                <div class="what-img">
                                    <img src="/themes/aznews/assets/img/news/recent2.jpg" alt="">
                                </div>
                                <div class="what-cap">
                                    <span class="color1">Night party</span>
                                    <h4><a href="#">Welcome To The Best Model  Winner Contest</a></h4>
                            ...
                            <div class="single-recent mb-100">
                                <div class="what-img">
                                    <img src="/themes/aznews/assets/img/news/recent3.jpg" alt="">
                                </div>
                                <div class="what-cap">
                                    <span class="color1">Night party</span>
                                    <h4><a href="#">Welcome To The Best Model  Winner Contest</a></h4>
